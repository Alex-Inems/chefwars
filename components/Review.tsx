...
const Review: React.FC = () => {
  ...
  return (
    <div className="bg-orange-500 p-6 rounded-lg shadow-lg w-full flex flex-col md:flex-row items-center">
      ...
      {/* Review Text Section */}
      <div className="w-full md:w-1/2 p-4 text-center flex flex-col justify-center order-2 md:order-1">
        <p className="text-gray-800 text-sm md:text-lg transition-opacity duration-500">
